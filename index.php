                ...
                'Cavite': {
                    ...
                    cities: {
                        ...
                        'Dasmariñas': {
                            ...
                            barangays: ['Burol', 'Salawag', 'Paliparan', 'Emilio Aguinaldo', 'San Jose', 'Santa Cruz', 'Sampaloc']
                        },
                        'Imus': {
                            coords: [14.4297, 120.9386],
                            barangays: ['Alapan', 'Anabu', 'Bayan Luma', 'Bukandala', 'Medicion', 'Tanzang Luma']
                        }
                    }
                },
                'Laguna': {
                    ...
                    cities: {
                        'San Pedro': {
                            coords: [14.3576, 121.0450],
                            barangays: ['United Bayanihan', 'San Lorenzo Ruiz', 'San Roque', 'Santo Niño', 'Langgam', 'G.S.I.S.', 'Calendola', 'Poblacion']
                        },
                        'Biñan': {
                            coords: [14.3416, 121.0851],
                            barangays: ['Bungahan', 'Canlalay', 'Casile', 'De La Paz', 'Ganado', 'Langkiwa', 'Poblacion', 'San Antonio', 'San Francisco', 'San Vicente']
                        },
                        'Calamba': {
                            coords: [14.2299, 121.1689],
                            barangays: ['Maitim', 'Masaya', 'Paciano Rizal', 'Palo-Alto', 'Pansol', 'Parian', 'Prinza', 'Real', 'San Cristobal', 'San Jose', 'San Juan']
                        }
                    }
                },
                'Bulacan': {
                    ...
                    cities: {
                        'Malolos': {
                            coords: [14.8441, 120.8116],
                            barangays: ['Bagna', 'Balayong', 'Bulihan', 'Caingin', 'Calero', 'Canalate']
                        },
                        'Meycauayan': {
                            coords: [14.7362, 120.9595],
                            barangays: ['Bahay Pare', 'Bancal', 'Langka', 'Lawa', 'Pajo', 'Poblacion']
                        },
                        'San Jose del Monte': {
                            coords: [14.8136, 121.0456],
                            barangays: ['Assumption', 'Citrus', 'Dulong Bayan', 'Fatima', 'Gaya-gaya', 'Graceville', 'Kaypian', 'Muzon']
                        }
                    }
                },
                'Rizal': {
                    ...
                    cities: {
                        'Antipolo': {
                            coords: [14.5846, 121.1761],
                            barangays: ['Bagong Nayon', 'Cupang', 'Dalig', 'Mayamot', 'San Isidro', 'San Jose']
                        },
                        'Cainta': {
                            coords: [14.5786, 121.1242],
                            barangays: ['San Andres', 'Sto. Niño', 'San Roque', 'San Juan']
                        },
                        'Taytay': {
                            coords: [14.5586, 121.1361],
                            barangays: ['Dolores', 'San Juan', 'Santa Ana', 'San Isidro']
                        }
                    }
                },
                'Batangas': {
                    ...
                    cities: {
                        'Batangas City': {
                            coords: [13.7599, 121.0570],
                            barangays: ['Alangilan', 'Balagtas', 'Bolo', 'Concepcion', 'Cuta', 'Gulod Labac', 'Kumintang Ibaba', 'Kumintang Ilaya']
                        },
                        'Lipa': {
                            coords: [13.9411, 121.1636],
                            barangays: ['Anilao', 'Antipolo del Norte', 'Antipolo del Sur', 'Balintawak', 'Bolbok', 'Bulaklakan']
                        },
                        'Tanauan': {
                            coords: [14.0838, 121.1496],
                            barangays: ['Altura Bata', 'Altura Matanda', 'Altura Sampaloc', 'Bañadero', 'Bagumbayan']
                        }
                    }
                }
            };
            ...
            function updatePatientChartWithDates() {
                ...
                patientsData.forEach(patient => {
                    ...
                    if (admissionDate) {
                        ...
                        if (!dateCount[fullDate]) {
                            dateCount[fullDate] = 0;
                        }
                        dateCount[fullDate]++;
                    }
                });
